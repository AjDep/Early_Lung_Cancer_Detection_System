    ...
    <div>
      ...
      <Container  breakpoints={['xxxl', 'xxl', 'xl', 'lg', 'md', 'sm', 'xs', 'xxs']}
        ...
        <Row className={style.hero}>
            ...
            <div  className="p-6 text-center " style={{marginTop: '87px', height:'635px', paddingTop:'100px'}}>
        ...
        <Row>
        <h1 style={{fontSize:'45px', fontWeight:'bold', textAlign:'center'}}>
        ...
        <Row>
            <Row className='p-5 row-cols-1  row-cols-xl-3 row-cols-sm-2 g-4 py-5' style={{height:'500px',alignItems:'center'}}>
                <Col>
